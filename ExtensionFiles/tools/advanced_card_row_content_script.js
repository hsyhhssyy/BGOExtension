...
var original_card_row = undefined;
...
chrome.extension.sendMessage(cfgRequestMsg,
    function(config) {
        ...
        if (card_row[0] != undefined && config["chrome.bgo-extension.advanced-card-row"]=="true") {
            ...
            originalCardRow = card_row.clone();
            ...
            if (msg.currentPlayer != msg.playerName && config["chrome.bgo-extension.advanced-card-row-active-player-disp-current"] == "true") {
